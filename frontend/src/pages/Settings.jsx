...
const Settings = () => {
  ...
  return (
    <>
      <h1 className="text-lg font-bold">โปรไฟล์ / Profile</h1>
      ...
      <div>
        <p className="text-xs font-semibold text-base-content/60 mb-2"><i className="fa-solid fa-chart-bar mr-1"></i> สถิติ / Statistics</p>
      ...
      <div className="bg-base-100 rounded-box border border-base-300 overflow-hidden">
        <p className="text-xs font-semibold text-base-content/60 px-4 pt-3 pb-1">
          <i className="fa-solid fa-gear mr-1"></i> การตั้งค่า / Settings
        </p>
        <div className="divide-y divide-base-200">
          <div className="flex items-center justify-between px-4 py-3.5">
            <div className="flex items-center gap-3">
              <i className="fa-solid fa-lock text-base-content/40 w-4"></i>
              <span className="text-sm">เปลี่ยนรหัส PIN / Change PIN</span>
            </div>
          ...
          <div className="flex items-center justify-between px-4 py-3.5">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm">การแจ้งเตือน / Notifications</span>
            </div>
            <input
              type="checkbox"
          ...
          <div className="flex items-center justify-between px-4 py-3.5">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm">อีเมลแจ้งเตือน / Email Notifications</span>
            </div>
            <input
              type="checkbox"
              className="toggle toggle-sm toggle-primary"
          ...
          <div className="flex items-center justify-between px-4 py-3.5">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm">ภาษา / Language</span>
            </div>
          ...
          <div className="flex items-center justify-between px-4 py-3.5">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm">อุปกรณ์ที่เชื่อมต่อ / Connected Devices</span>
            </div>
            <i className="fa-solid fa-chevron-right text-xs text-base-content/30"></i>
          </div>
          <div className="flex items-center justify-between px-4 py-3.5">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm">ความปลอดภัย / Security</span>
            </div>
            <i className="fa-solid fa-chevron-right text-xs text-base-content/30"></i>
          </div>
        </div>
      ...
      <div className="text-center">
        <p className="text-caption text-base-content/30"><i className="fa-solid fa-circle-info mr-1"></i> เวอร์ชัน / Version: 1.0.0 | Acard Wallet</p>
      </div>
    </>
  );
};
