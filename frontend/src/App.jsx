...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/applications/history" element={isAuthenticated && hasPin ? <ApplicationHistory /> : <Navigate to="/login" />} />
      ...
      <Route path="/applications/step1" element={isAuthenticated && hasPin ? <ApplicationStep1 /> : <Navigate to="/login" />} />
      <Route path="/applications/step2" element={isAuthenticated && hasPin ? <ApplicationStep2 /> : <Navigate to="/login" />} />
      <Route path="/applications/step3" element={isAuthenticated && hasPin ? <ApplicationStep3 /> : <Navigate to="/login" />} />
      <Route path="/applications/verify" element={isAuthenticated && hasPin ? <ApplicationVerify /> : <Navigate to="/login" />} />
